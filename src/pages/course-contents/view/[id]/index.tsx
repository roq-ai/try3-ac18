...
import { getCourseContentById } from 'apiSdk/course-contents';
...
function CourseContentViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Course Content Detail View
          </Text>
          {hasAccess('course_content', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/course-contents/edit/${data?.id}`} passHref legacyBehavior>
              <Button
