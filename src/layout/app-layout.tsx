...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['course-content-generator', 'quiz-generator', 'exercise-generator', 'use-case-generator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Use Case', path: '/use-cases', entity: 'use_case', service: AccessServiceEnum.PROJECT, icon: FiBriefcase },
